...
function qa_question_set_selchildid($userid, $handle, $cookieid, $oldquestion, $selchildid, $answers)
{
	...
	//Mel: 14/01/22. Deduct coins to questioner to be given to answerer
	...
	if (isset($oldselchildid) && isset($answers[$oldselchildid])) {
		...
		//Mel: 14/01/22. Give coins to answerer for getting their answer selected
	...
	if (isset($selchildid)) {
		...
		//Mel: 14/01/22. Give reward points to answerer
