...
if (QA_FINAL_EXTERNAL_USERS) {
	...
	function qa_get_logged_in_points()
	{
		...
		if (!isset($qa_cached_logged_in_points)) {
			...
			$qa_cached_logged_in_points = qa_db_get_coins_balance(qa_get_logged_in_userid());	//Mel: 16/01/22
	...
	function qa_get_logged_in_points()
	{
		require_once QA_INCLUDE_DIR . 'db/points.php';	//Mel: 16/01/22

		if (qa_to_override(__FUNCTION__)) { $args=func_get_args(); return qa_call_override(__FUNCTION__, $args); }

		return qa_db_get_coins_balance(qa_get_logged_in_userid());	//Mel: 16/01/22
